...
public class TouristController {
    ...
    public ResponseEntity<TouristInfoDto> getTouristById(@PathVariable(value = "id") Long tourist_Spot_id
                       , @SessionAttribute(value = "loginMember", required = false) Member loginMember) {
        try {
            TouristInfoDto findTourist = touristService.getTouristById(tourist_Spot_id, loginMember);
